...
namespace ZXing.QrCode
{
   ...
   public class QRCodeReader : Reader
   {
      ...
      public Result decode(BinaryBitmap image, IDictionary<DecodeHintType, object> hints)
      {
         ...
         ResultPoint[] points;
         QRCodeDetectorResult detectorResult = null;
         ...
         {
            detectorResult = new Detector(image.BlackMatrix).detect(hints);
         ...
         if (detectorResult != null)
             result.putMetadata(ResultMetadataType.QRCODE_DIMENSION, detectorResult.Dimension);
