...
namespace ZXing.QrCode.Internal
{
   ...
   public class Detector
   {
      ...
      ///   <see cref="DetectorResult"/> encapsulating results of detecting a QR Code
      /// </returns>
      public virtual QRCodeDetectorResult detect(IDictionary<DecodeHintType, object> hints)
      {
      ...
      /// <returns></returns>
      protected internal virtual QRCodeDetectorResult processFinderPatternInfo(FinderPatternInfo info)
      {
         ...
         return new QRCodeDetectorResult(bits, points, moduleSize, dimension);
      }
